        ...
        await strategy.ExecuteAsync(async () =>
        {
            ...
            var prizes = new List<Prize>() {
                    new()
                    {
                        ...
                        PromocodeId = promocodes.ElementAt(0).Code,
                        Promocode = promocodes.ElementAt(0)
                    },
                    new()
                    {
                        ...
                        PromocodeId = promocodes.ElementAt(1).Code,
                        Promocode = promocodes.ElementAt(1)
                    },
                    new()
                    {
                        ...
                        PromocodeId = promocodes.ElementAt(2).Code,
                        Promocode = promocodes.ElementAt(2)
                    },
                    new()
                    {
                        ...
                        PromocodeId = promocodes.ElementAt(3).Code,
                        Promocode = promocodes.ElementAt(3)
                    },
                    new()
                    {
                        ...
                        ImageUrl = "https://example.com/image4.jpg",
                        PromocodeId = promocodes.ElementAt(4).Code,
                        Promocode = promocodes.ElementAt(4)
                    },
                    new()
                    {
                        ...
                        ImageUrl = "https://example.com/image4.jpg",
                        PromocodeId = promocodes.ElementAt(5).Code,
                        Promocode = promocodes.ElementAt(5)
                    },
                    new()
                    {
                        ...
                        ImageUrl = "https://example.com/image4.jpg",
                        PromocodeId = promocodes.ElementAt(6).Code,
                        Promocode = promocodes.ElementAt(6)
                    },
                    new()
                    {
                        ...
                        ImageUrl = "https://example.com/image4.jpg",
                        PromocodeId = promocodes.ElementAt(7).Code,
                        Promocode = promocodes.ElementAt(7)
                    },
                    new()
                    {
                        ...
                        ImageUrl = "https://example.com/image4.jpg",
                        PromocodeId = promocodes.ElementAt(8).Code,
                        Promocode = promocodes.ElementAt(8)
                    },
                    new()
                    {
                        ...
                        ImageUrl = "https://example.com/image4.jpg",
                        PromocodeId = promocodes.ElementAt(9).Code,
                        Promocode = promocodes.ElementAt(9)
                    },
                };
